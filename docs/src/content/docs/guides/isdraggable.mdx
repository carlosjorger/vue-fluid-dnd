---
title: isDraggable
description: A guide to use Vue Fluid DnD with isDraggable property.
---
...
With **Vue Fluid DnD** you can control which element can be dragged and which not using `isDraggable` property:
