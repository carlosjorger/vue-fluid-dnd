...
description: A guide on how to use Vue Fluid DnD to remove elements from a list.
---

import ListWithInsert from "@/components/ListWithInsert.vue";
import { Code } from "@astrojs/starlight/components";

### List of number example

To showing how to use **Vue Fluid DnD** for inserting elements to a list.
...
<div class="p-8 bg-[var(--sl-color-gray-6)]">
  <ListWithInsert insertingFromClass="inserting" delayBeforeRemove={800} client:load  />
</div>